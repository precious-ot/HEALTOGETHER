    ...
    return(
        <div className={className}>
            ...
            <ul className="ps-4 mt-2">
                <li>
                    <a href="#" onClick={handleCommunity} className={`flex place-items-center gap-3 cursor-pointer text-[#5d4e37] px-3 py-2 hover:bg-[#f0e6d6] hover:rounded-full hover:shadow-md mb-2 ${community ? "bg-linear-to-r from-[#d4a574] to-[#b8956a] text-white rounded-full shadow-md" : "bg-black-950"}`}>                       
                ...
                <li>
                    <a href="#" onClick={handleMessage} className={`flex place-items-center gap-3 cursor-pointer text-[#5d4e37] px-3 py-2 hover:bg-[#f0e6d6] hover:rounded-full hover:shadow-md mb-2 ${message ? "bg-linear-to-r from-[#d4a574] to-[#b8956a] text-white rounded-full shadow-md" : "bg-black-950"}`}>
                ...
                <li>
                    <a href="#" onClick={handleResources} className={`flex place-items-center gap-3 cursor-pointer text-[#5d4e37] px-3 py-2 hover:bg-[#f0e6d6] hover:rounded-full hover:shadow-md mb-2 ${resources ? "bg-linear-to-r from-[#d4a574] to-[#b8956a] text-white rounded-full shadow-md" : "bg-black-950"}`}>
                ...
                <li>
                    <a href="#" onClick={handleProfile} className={`flex place-items-center gap-3 cursor-pointer text-[#5d4e37] px-3 py-2 hover:bg-[#f0e6d6] hover:rounded-full hover:shadow-md mb-2 ${profile ? "bg-linear-to-r from-[#d4a574] to-[#b8956a] text-white rounded-full shadow-md" : "bg-black-950"}`}>
